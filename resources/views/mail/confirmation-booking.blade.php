                ...
                <tr>
                    <td align="center" style="background-color: red; height: 50px;">
                        <div style="text-decoration: none;">
                            <p style="color:white; font-weight:bold;">Booking Confirmation</p>
                        </div>
                    </td>
                </tr>
                <tr style="height: 300px;">
                    <td align="center" style="border: none; border-bottom: 2px solid red; padding-right: 20px; padding-left: 20px;">
                        <p style="font-weight: bolder; font-size: 42px; letter-spacing: 0.025em; color:black;">
                            <b>Booking Confirmed</b><br>
                            <b>Contact : {{$user->email}}</b><br>
                        </p>
                    </td>
                </tr>
